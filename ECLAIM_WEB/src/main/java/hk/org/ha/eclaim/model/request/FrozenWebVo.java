...
public class FrozenWebVo extends CommonWebVo {
	...
	private List<String> frozenEndDate = new ArrayList<String>();
	...
	public List<String> getFrozenEndDate() {
		return frozenEndDate;
	}

	public void setFrozenEndDate(List<String> frozenEndDate) {
