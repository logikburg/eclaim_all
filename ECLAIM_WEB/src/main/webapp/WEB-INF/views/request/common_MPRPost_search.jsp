...
<script>
	function performSearch() {
		...
		$("#hiddenFromRankName").val(typeof fromRankName == 'undefined' ? "" : fromRankName);
		
		var url = "<%=request.getContextPath() %>/api/request/searchVacantPost";
		if (typeof fromPost != 'undefined') {
			if (fromPost == "N") {
		...
		<div class="modal-content">
		    ...
		    <div class="modal-body">
		    	<form id="searchPosition">
			    	...
			    	<form:hidden path="formBean.fromRankName" id="hiddenFromRankName"/>
