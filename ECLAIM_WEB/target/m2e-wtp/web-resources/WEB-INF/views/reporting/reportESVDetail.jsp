...
<script>
	...
	function performReset() {
		document.location.href = "<%= request.getContextPath() %>/reporting/reportESVDetail";
	}
...
<div id="page-content-wrapper">
	<div class="container-fluid">
		<div class="breadcrumbs">
			<a href="<c:url value="/home/home"/>"><i class="fa fa-home"></i>Home</a> > <a href="<c:url value="/reporting/reportHome"/>">Reporting</a> > ESV Details
		</div>
		<div class="section-title">
			<div class="title pull-left"><i class="fa fa-file-pdf-o"></i>ESV Details</div>
		</div>
