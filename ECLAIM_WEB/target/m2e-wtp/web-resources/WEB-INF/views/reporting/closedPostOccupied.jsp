...
<script>
	...
	function performReset() {
		document.location.href = "<%= request.getContextPath() %>/reporting/closedPostOccupied";
	}
...
<div id="page-content-wrapper">
	<div class="container-fluid">
		<div class="breadcrumbs">
			<a href="<c:url value="/home/home"/>"><i class="fa fa-home"></i>Home</a> > <a href="<c:url value="/reporting/reportHome"/>">Reporting</a> > Closed and Frozen Post being occupied
		</div>
		<div class="section-title">
			<div class="title pull-left"><i class="fa fa-file-pdf-o"></i>Closed and Frozen Post being occupied</div>
		</div>
