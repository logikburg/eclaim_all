...
<script>
	function performReset() {
		document.location.href = "<%= request.getContextPath() %>/reporting/dataExport";
	}
	...
	function changeStaffGroup() {
		...
		if ($("#staffGroupCode").val() == "MEDICAL") {
			$("#lblDepartment").text("Department");
		}
		else {
			$("#lblDepartment").text("Specialty");
		}
	}
	
	function refreshDepartmentDropdown() {
		var tmpDept = $("#department").val();
	
		$.ajax ({
            url: "<%=request.getContextPath()%>/common/getDeptByStaffGroup",
            type: "POST",
            data: {staffGroupCode: $("#staffGroupCode").val()},
            success: function(data) {
            	$("#department").empty();
            	var option = "<option value=''> - Select - </option>";
	...
	function refreshRankDropdown() {
		var tmpRank = $("#rankCode").val();
	
		$.ajax ({
            url: "<%=request.getContextPath()%>/common/getRankByStaffGroup",
            type: "POST",
            data: {staffGroupCode: $("#staffGroupCode").val(), deptCode: $("#department").val()},
            success: function(data) {
            	 $("#rankCode").empty();
            	 var option = "<option value=''> - Select - </option>";
            	 $("#rankCode").append(option);
...
<div id="page-content-wrapper">
	<div class="container-fluid">
		<div class="breadcrumbs">
			<a href="<c:url value="/home/home"/>"><i class="fa fa-home"></i>Home</a> > <a href="<c:url value="/reporting/reportHome"/>">Reporting</a> > Data Export
		</div>
		<div class="section-title">
			<div class="title pull-left"><i class="fa fa-file-excel-o"></i>Data Export</div>
		</div>
			...
			<div class="panel panel-custom-primary">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-2">
							<label for="" class="control-label">As at<font class="star">*</font></label>
						</div>
						<div class="col-sm-2">
							<div class='input-group date' id='datetimepicker1'>
								<input type='text' name="asAtDate" class="form-control" required="required" />
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<form:select path="formBean.clusterCode" name="clusterCode" class="form-control" onchange="changeCluster()">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<form:select path="formBean.instCode" name="instCode" class="form-control">
								<option value="">- Select -</option>
					...
					<div class="row">
						<div class="col-sm-2">
							<label for="" class="field_request_label"><font id="lblDepartment">Department</font></label>
						</div>
						<div class="col-sm-4">
							<form:select path="formBean.department" name="deptCode" class="form-control" onchange="changeDepartment()">
								<option value="">- Select -</option>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-4">
								<form:select path="formBean.staffGroupCode" name="staffGroupCode" class="form-control" onchange="changeStaffGroup()" required="required">
									<option value="">- Select -</option>
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<form:select path="formBean.rankCode" name="rankCode" class="form-control">
								<option value="">- Select -</option>
