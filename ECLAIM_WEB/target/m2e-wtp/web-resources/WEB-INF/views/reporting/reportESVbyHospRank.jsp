...
<script>
	...
	function performReset() {
		document.location.href = "<%= request.getContextPath() %>/reporting/reportESVbyHospRank";
	}
	...
	$(function(){
		$("#frmDetailRpt").bootstrapValidator({
		...
		$("#frmDetailRpt .input-group.date").datepicker({
	  		format: "dd/mm/yyyy",
	  		autoclose: true,
	  	...
	  	.on('changeDate', function(e) {
	  		if ($(this).next().hasClass('help-block')) {
	  			$("#frmDetailRpt").bootstrapValidator('revalidateField', $($(this).parent().find("input")[0]).attr("name"));
	  		}
	  	});
	...
	function refreshRankDropdown() {
		...
		$.ajax ({
            ...
            type: "POST",
            data: {staffGroupCode: $("#staffGroupCode").val(), deptCode: ""},
            success: function(data) {
            	 $("#rankCode").empty();
            	 var option = "<option value=''> - Select - </option>";
...
<div id="page-content-wrapper">
	<div class="container-fluid">
		<div class="breadcrumbs">
			<a href="<c:url value="/home/home"/>"><i class="fa fa-home"></i>Home</a> > <a href="<c:url value="/reporting/reportHome"/>">Reporting</a> > ESV By Hospitals and Ranks
		</div>
		<div class="section-title">
			<div class="title pull-left"><i class="fa fa-file-pdf-o"></i>ESV By Hospitals and Ranks</div>
		</div>
		<form id="frmDetailRpt" method="POST">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class='input-group date' id='datetimepicker1'>
								<form:input path="formBean.asAtDate" id="dateAsAt" class="form-control" required="required"></form:input>
