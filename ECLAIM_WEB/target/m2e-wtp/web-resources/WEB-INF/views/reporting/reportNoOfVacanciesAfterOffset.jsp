...
<script>
	...
	function performReset() {
		document.location.href = "<%= request.getContextPath() %>/reporting/reportNoOfVacanciesAfterOffset";
	}
...
<div id="page-content-wrapper">
	<div class="container-fluid">
		<div class="breadcrumbs">
			<a href="<c:url value="/home/home"/>"><i class="fa fa-home"></i>Home</a> > <a href="<c:url value="/reporting/reportHome"/>">Reporting</a> > No. of Vacancies &amp; No. of Vacancies after off setting the Contract Part-time &amp; Temporary Staff
		</div>
		<div class="section-title">
			<div class="title pull-left"><i class="fa fa-file-pdf-o"></i>No. of Vacancies &amp; No. of Vacancies after off setting the Contract Part-time &amp; Temporary Staff</div>
		</div>
		...
		<form id="frmDetail" method="POST">
			...
			<div class="panel panel-custom-primary">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-2">
							<label for="" class="field_request_label">Group By</label>
						</div>
						<div class="col-sm-8">
							<form:radiobutton path="formBean.groupBy"
										      id="rbGroupBy1" name="rbGroupBy" value="I"></form:radiobutton> By Institution
							<form:radiobutton path="formBean.groupBy"
										      id="rbGroupBy2" name="rbGroupBy" value="D"></form:radiobutton> By Department and Rank
						</div>
					</div>
					<div class="row">
						<div class="col-sm-2">
